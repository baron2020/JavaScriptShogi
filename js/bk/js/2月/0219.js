...
//①王の動き
if((teban=="先手")&&(firstTouchPiece.substr(0,2)=="ou")){
	temp1=(kys-1);//上の動き
	temp2=(kys+1);//下の動き
	temp3=(kxs-1);//左の動き
	temp4=(kxs+1);//右の動き
	pieceMotion1="d"+temp1+"s"+temp3;//王の動き①
	pieceMotion2="d"+temp1+"s"+kxs;//王の動き②
	pieceMotion3="d"+temp1+"s"+temp4;//王の動き③
	pieceMotion4="d"+kys+"s"+temp3;//王の動き④
	pieceMotion5="d"+kys+"s"+temp4;//王の動き⑤
	pieceMotion6="d"+temp2+"s"+temp3;//王の動き⑥
	pieceMotion7="d"+temp2+"s"+kxs;//王の動き⑦
	pieceMotion8="d"+temp2+"s"+temp4;//王の動き⑧
	if((temp1>=1)&&(temp1<=9)){
		cssRule(pieceMotion2);
		if((temp3>=1)&&(temp3<=9)){
			cssRule(pieceMotion1);
			cssRule(pieceMotion4);
		}
		if((temp4>=1)&&(temp4<=9)){
			cssRule(pieceMotion3);
			cssRule(pieceMotion5);
		}
	}
	if((temp2>=1)&&(temp2<=9)){
		cssRule(pieceMotion7);
		if((temp3>=1)&&(temp3<=9)){
			cssRule(pieceMotion4);
			cssRule(pieceMotion6);
		}
		if((temp4>=1)&&(temp4<=9)){
			cssRule(pieceMotion5);
			cssRule(pieceMotion8);
		}
	}
}
//②飛車の動き
if((teban=="先手")&&(firstTouchPiece.substr(0,5)=="hisya")){
	temp1=(kys-1);//上の動き
	temp2=(kys+1);//下の動き
	temp3=(kxs-1);//左の動き
	temp4=(kxs+1);//右の動き
	pieceMotion1="d"+temp1+"s"+kxs;//飛車の動き①
	pieceMotion2="d"+kys+"s"+temp3;//飛車の動き②
	pieceMotion3="d"+kys+"s"+temp4;//飛車の動き③
	pieceMotion4="d"+temp2+"s"+kxs;//飛車の動き④
	if((temp1>=1)&&(temp1<=9)){
		cssRule(pieceMotion1);
	}
	if((temp3>=1)&&(temp3<=9)){
...
//③角の動き
if((teban=="先手")&&(firstTouchPiece.substr(0,4)=="kaku")){
	temp1=(kys-1);//上の動き
	temp2=(kys+1);//下の動き
	temp3=(kxs-1);//左の動き
	temp4=(kxs+1);//右の動き
	pieceMotion1="d"+temp1+"s"+temp3;//角の動き①
	pieceMotion2="d"+temp1+"s"+temp4;//角の動き②
	pieceMotion3="d"+temp2+"s"+temp3;//角の動き③
	pieceMotion4="d"+temp2+"s"+temp4;//角の動き④
	if((temp1>=1)&&(temp1<=9)){
		if((temp3>=1)&&(temp3<=9)){
			cssRule(pieceMotion1);
		}
...
//④金の動き
if((teban=="先手")&&(firstTouchPiece.substr(0,3)=="kin")){
	temp1=(kys-1);//上の動き
	temp2=(kys+1);//下の動き
	temp3=(kxs-1);//左の動き
	temp4=(kxs+1);//右の動き
	pieceMotion1="d"+temp1+"s"+temp3;//金の動き①
	pieceMotion2="d"+temp1+"s"+kxs;//金の動き②
	pieceMotion3="d"+temp1+"s"+temp4;//金の動き③
	pieceMotion4="d"+kys+"s"+temp3;//金の動き④
	pieceMotion5="d"+kys+"s"+temp4;//金の動き⑤
	pieceMotion6="d"+temp2+"s"+kxs;//金の動き⑥
	if((temp1>=1)&&(temp1<=9)){
		cssRule(pieceMotion2);
		if((temp3>=1)&&(temp3<=9)){
			cssRule(pieceMotion1);
...
//⑤銀の動き
if((teban=="先手")&&(firstTouchPiece.substr(0,3)=="gin")){
	temp1=(kys-1);//上の動き
	temp2=(kys+1);//下の動き
	temp3=(kxs-1);//左の動き
	temp4=(kxs+1);//右の動き
	pieceMotion1="d"+temp1+"s"+temp3;//銀の動き①
	pieceMotion2="d"+temp1+"s"+kxs;//銀の動き②
	pieceMotion3="d"+temp1+"s"+temp4;//銀の動き③
	pieceMotion4="d"+temp2+"s"+temp3;//銀の動き④
	pieceMotion5="d"+temp2+"s"+temp4;//銀の動き⑤
	if((temp1>=1)&&(temp1<=9)){
		cssRule(pieceMotion2);
		if((temp3>=1)&&(temp3<=9)){
			cssRule(pieceMotion1);
...
//⑥桂馬の動き
if((teban=="先手")&&(firstTouchPiece.substr(0,5)=="keima")){
	temp1=(kys-2);//上の動き
	temp2=(kxs-1);//左の動き
	temp3=(kxs+1);//右の動き
	pieceMotion1="d"+temp1+"s"+temp2;//桂馬の動き①
	pieceMotion2="d"+temp1+"s"+temp3;//桂馬の動き②
	if((temp1>=1)&&(temp1<=9)){
		if((temp2>=1)&&(temp2<=9)){
			cssRule(pieceMotion1);
		}
...
//⑦香の動き
if((teban=="先手")&&(firstTouchPiece.substr(0,4)=="kyou")){
	temp1=(kys-1);//歩の上の動き
	pieceMotion1="d"+temp1+"s"+kxs;//香の動き①
	cssRule(pieceMotion1);
	}
//⑧歩の動き
if((teban=="先手")&&(firstTouchPiece.substr(0,2)=="hu")){
	temp1=(kys-1);//歩の上の動き
	pieceMotion1="d"+temp1+"s"+kxs;//歩の動き①
	//歩は必ず盤内の動きである。
//ReverseCssRule(pieceMotion1);
	cssRule(pieceMotion1);
	}
}
...
//変更したマスを元に戻す
function ReverseCssRule(rulePiece){
document.getElementById(rulePiece).style.backgroundColor="khaki";
document.getElementById(rulePiece).style.border="0.5px solid black";
document.getElementById(rulePiece).style.boxSizing="border-box";
}
//全てのマスを元に戻す
function AllReverseCssRule(){
ReverseCssRule(pieceMotion1);
//ReverseCssRule(pieceMotion2);
//ReverseCssRule(pieceMotion3);
//ReverseCssRule(pieceMotion4);
//ReverseCssRule(pieceMotion5);
//ReverseCssRule(pieceMotion6);
//ReverseCssRule(pieceMotion7);
//ReverseCssRule(pieceMotion8);
}
//リセット用
function reset(){//
