...
//先手陣か？
function sentejin(currentMasu){
	//正規表現
	let regex1=new RegExp(/d7s[1-9]/);
	let regex2=new RegExp(/d8s[1-9]/);
	let regex3=new RegExp(/d9s[1-9]/);
	let promotion1=regex1.test(currentMasu);
	let promotion2=regex2.test(currentMasu);
	let promotion3=regex3.test(currentMasu);
...
//桂馬が必ず成る後手陣の１段目,２段目か？
function gotejinKeima(currentMasu){
	//正規表現
	let regex1=new RegExp(/d1s[1-9]/);
	let regex2=new RegExp(/d2s[1-9]/);
	let promotion1=regex1.test(currentMasu);
...
//香,歩が必ず成る後手陣の１段目か？
function gotejinKyouFu(currentMasu){
	//正規表現
	let regex1=new RegExp(/d1s[1-9]/);
	let promotion1=regex1.test(currentMasu);
	if(promotion1){
...
//桂馬が必ず成る先手陣の８段目,９段目か？
function sentejinKeima(currentMasu){
	//正規表現
...
//香,歩が必ず成る先手陣の９段目か？
function sentejinKyouFu(currentMasu){
	//正規表現
